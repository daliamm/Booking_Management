    ...
    <div class="container">
        <div class="main-body">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="card">
						<form action="{{route('stmp.update')}}" method="post" enctype="multipart/form-data">
                         @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                    <h6 class="mb-0">User Namr</h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
                                    <div class="mb-3">
                                        <input class="form-control" type="text" name="username"   value="{{$smtp->username}}"  >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <div class="mb-3">
                                        <input class="form-control" type="text" name="password"   value="{{$smtp->password}}"  >
                                    </div>
                                </div>
