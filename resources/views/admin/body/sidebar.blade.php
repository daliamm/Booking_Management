<div class="sidebar-wrapper" data-simplebar="true">{{asset('backend/')}}
			<div class="sidebar-header">
				...
				<div class="toggle-icon ms-auto"><i class='bx bx-cookie'></i>
				</div>
			 </div>
			<!--navigation-->
			...
			<li>
				...
				<li>
					...
					<ul>
						<li> <a href="{{route('booking.report')}}"><i class='bx bx-radio-circle'>
