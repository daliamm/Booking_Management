        ...
        <nav class="navbar navbar-expand gap-3">
                ...
                <ul class="navbar-nav align-items-center gap-1">
                    ...
                    <li class="nav-item dropdown dropdown-large">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#"
                            ...
                            @endphp
                            <span class="alert-count" id="notificatioin-count">{{$ncount}}</span>
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#"
                    ...
                    <img src="{{(!empty($profileData->photo)) ? url('/upload/admin_images/'.$profileData->photo) : url('upload//admin_images/no_image.jpg')}}"
...
<script>
	...
	function markNotificationAsRead(notificationId){
		...
		.then(data=>{
			document.getElementById('notificatioin-count').textContent=data.count;
		})
		.catch(error=>{
