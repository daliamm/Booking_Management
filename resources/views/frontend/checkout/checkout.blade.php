...
<section class="checkout-area pt-100 pb-70">
    <div class="container">
        <form method="" role="form" action="{{ route('checkout.store')}}">
            <form role="form" method="post" action="{{ route('checkout_store') }}"
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="payment-box">
                            <div class="payment-method">
                                <p>
                                    <input type="radio" id="stripe" name="payment-method" class="pay_method" value="Stripe">
