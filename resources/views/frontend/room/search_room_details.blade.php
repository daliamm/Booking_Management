                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input autocomplete="off" type="text" name="check_in" id="check_in" required
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input autocomplete="off" type="text" name="check_in" id="check_out"
                                                required class="form-control dt_picker"
                ...
                <div class="room-details-article">
                    <div class="room-details-slider owl-carousel owl-theme">
                        ...
                        <div class="room-details-item">
                            <img src="{{asset('upload/rooming/multi_img/'.$imag->multi_img)}}" alt="Images">
                        </div>
                        @endforeach
                    ...
                    <div class="room-details-title">
                        ...
                        <ul>
                            ...
                            <li>
                                <b> Basic :$ {{$roomdetails->price}}/Room</b>
                            </li>
                            ...
                            <div class="col-lg-6">
                                <div class="services-bar-widget">
                                    ...
                                    <div class="side-bar-list">
                                        <ul>
                                            <li>
                                                <a href="#"> <b>Number Of Seats : </b> {{$roomdetails->number_seats}} <i
                                                        class='bx bxs-cloud-download'></i></a>
                                            </li>
                                            <li>
                                                <a href="#"> <b>Discount : </b> {{$roomdetails->discount}} <i
                                                        class='bx bxs-cloud-download'></i></a>
                                            </li>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-7 col-md-8 p-0">
                            <div class="room-card-content">
                                <h3>
                                    <a href="{{url('room/deltails/'.$item->id)}}">{{$item['type']['room']}}</a>
                                </h3>
                                <span>{{$item->price}}/ Per h </span>
                                <div class="rating">
...
function getAvaility(check_in, check_out, room_id) {
    $.ajax({
        ...
        success: function(data) {
            ...
            price_calculate(data['total_day ']);
        }
    });
}
